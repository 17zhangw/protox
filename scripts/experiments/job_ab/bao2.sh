...
python3 scripts/experiments/job_ab/load_job_ab.py --config-file configs/job.yaml.5452
...
OUTPUT_BASE=/home/wz2/mythril/exps_job_ab/bao_runs/
mkdir -p $OUTPUT_BASE
#rm -rf $OUTPUT_BASE/*
...
do
	...
	python3 run_queries.py \
		...
		--port 5452 \
		--num-arms $ARMS \
		--qorder "/home/wz2/mythril/queries/job_ab/qorder.txt" \
