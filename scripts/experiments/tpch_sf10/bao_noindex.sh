...
python3 scripts/experiments/tpch_sf10/load_tpch_noindex.py
...
OUTPUT_BASE=/home/wz2/mythril/exps_tpch_sf10/bao_noidx_runs/
mkdir -p $OUTPUT_BASE
rm -rf $OUTPUT_BASE/*
...
do
	...
	OUT_LOG=$OUTPUT_BASE/bao_noindex_out$idx.log
