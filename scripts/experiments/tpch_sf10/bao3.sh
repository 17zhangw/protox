...
python3 scripts/experiments/tpch_sf10/load_tpch.py --config-file configs/tpch_sf10.yaml.5453
...
/mnt/nvme0n1/wz2/noisepage/pg_ctl start -D $NOISEPAGE_DIR/pgdata5453 --log=pg.5453
