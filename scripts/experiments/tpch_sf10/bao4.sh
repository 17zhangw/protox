...
python3 scripts/experiments/tpch_sf10/load_tpch.py --config-file configs/tpch_sf10.yaml.5450
...
/mnt/nvme0n1/wz2/noisepage/pg_ctl start -D $NOISEPAGE_DIR/pgdata5450 --log=pg.5450
...
do
	...
	#sleep 5
	#rm -rf ~/mythril/Bao_4/bao_server/bao_previous_model
	#rm -rf ~/mythril/Bao_4/bao_server/bao_default_model
	#rm -rf ~/mythril/Bao_4/bao_server/bao.db
