...
CONFIGS=( "/home/wz2/mythril/scripts/experiments/tpch_sf10/tpch.1" )
ARCHIVES=( "/home/wz2/mythril/data/tpch_sf10.tgz" )
NAMES=( "unitune_lowmem1_" )
...
do
	...
	do
		...
		rm -rf unitune/UniTune/logs_lowmem1
		rm -rf /tmp/indexsize.json.5433
		rm -rf /tmp/tmp.cnf
		launch_db

		(cd unitune/UniTune && python3 main.py --config-ini ${CONFIG})
		mv unitune/UniTune/logs_lowmem1 ${OUTPUT_BASE}/$NAME$j
	done
done
