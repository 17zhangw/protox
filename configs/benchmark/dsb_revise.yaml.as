mythril:
  ...
  query_spec:
    ...
    query_directory: "/home/wz2/mythril/queries/dsb"
    query_order: "/home/wz2/mythril/queries/dsb/d_order.txt"
    tbl_include_subsets_prune: True

    tbl_fold_subsets: True
    tbl_fold_delta: 1
  ...
  attributes:
    ...
    catalog_returns:
      ...
      - cr_net_loss
    web_returns:
      _ wr_returned_date_sk
      _ wr_returned_time_sk
      _ wr_item_sk
      _ wr_refunded_customer_sk
      _ wr_refunded_cdemo_sk
      _ wr_refunded_hdemo_sk
      _ wr_refunded_addr_sk
      _ wr_returning_customer_sk
      _ wr_returning_cdemo_sk
      _ wr_returning_hdemo_sk
      _ wr_returning_addr_sk
      _ wr_web_page_sk
      _ wr_reason_sk
      _ wr_order_number
      _ wr_return_quantity
      _ wr_return_amt
      _ wr_return_tax
      _ wr_return_amt_inc_tax
      _ wr_fee
      _ wr_return_ship_cost
      _ wr_refunded_cash
      _ wr_reversed_charge
      _ wr_account_credit
      _ wr_net_loss
    web_sales:
      - ws_sold_date_sk
  ...
  per_query_knobs: {}
  per_query_knob_gen:
      enable_parallel_append: {type: "boolean", min: 0, max: 1, quantize: 0, log_scale: 0, unit: 0}
      ...
      parallel_leader_participation: {type: "boolean", min: 0, max: 1, quantize: 0, log_scale: 0, unit: 0}
