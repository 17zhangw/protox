with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2002-02-09','2002-04-16','2002-07-16','2002-10-28')))
 ...
 and sr_reason_sk in (3, 20, 40, 43, 51)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (3, 20, 40, 43, 51)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (3, 20, 40, 43, 51)
 group by i_item_id)
