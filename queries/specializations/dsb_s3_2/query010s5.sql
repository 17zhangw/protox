select 
 ...
 where
  ...
  ca_county in ('Bingham County','Cheshire County','Choctaw County','Tillamook County','Webster County') and
  c.c_birth_month in (4, 5) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('W', 'S', 'D')
  and cd_education_status in ('Advanced Degree', 'Unknown', 'Unknown')
  and cd_gender = 'F' and
  exists (select *
